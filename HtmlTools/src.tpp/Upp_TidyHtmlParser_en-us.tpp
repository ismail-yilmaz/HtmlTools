...
[s3; &]
[s4; &]
[s5;:Upp`:`:TidyHtmlParser`:`:GetRoot`(`): Node [* GetRoot]()&]
[s2;%% Returns the root node &]
[s3; &]
[s4; &]
[s5;:Upp`:`:TidyHtmlParser`:`:GetHtml`(`): Node [* GetHtml]()&]
[s2;%% Returns the <html> node..&]
[s3; &]
[s4; &]
[s5;:Upp`:`:TidyHtmlParser`:`:GetHead`(`): Node [* GetHead]()&]
[s2;%% Returns the <head> node..&]
[s3; &]
[s4; &]
[s5;:Upp`:`:TidyHtmlParser`:`:GetBody`(`): Node [* GetBody]()&]
